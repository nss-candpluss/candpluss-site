...
export function SupportHero() {
  ...
  return (
    <section data-header-theme="onDark" className="relative h-svh overflow-hidden">
      <SiteImage
        src={hero.image}
        alt=""
        fill
      ...
      <div className="relative z-10 flex h-full items-center px-[var(--container-x)] py-[var(--container-y-bottom)]">
        <div className="mx-auto w-full text-center text-white">
          ...
          <p className={`mt-[calc(32px*var(--gap-scale-y))] whitespace-pre-line font-body-ja ${bodyText(18)}`}>
            {hero.body}
          </p>
        </div>
      </div>
