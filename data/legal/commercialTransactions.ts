  ...
  items: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: "より多くのお客様にご購入いただけるよう、商品によっては購入数量の制限を設けております。制限数は各商品ページに記載しております。制限数を超えるご注文、または個人のご利用として常識の範囲を超える大量のご注文については、ご注文をキャンセルさせていただく場合があります。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: "■不良品・誤配送の場合\n商品に初期不良（破損・不具合）またはご注文内容と異なる商品が届いた場合には、商品到着後8日以内にご連絡ください。確認のうえ、返品または交換を承ります。この場合の返送料は当社が負担いたします。\nなお、商品の状態確認のために通常想定される方法で行われた開封・使用については、返品・交換を妨げるものではありません。",
        },
        {
          type: "paragraph",
